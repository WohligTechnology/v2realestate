<!DOCTYPE html>
<html>
<title><?php echo $title;?> - V2RealEstate Pvt Ltd</title>
	...
	<header>
			...
			<ul id="slide-out" class="side-nav fixed">
				<li class="sub-menu logo">
						<a id="logo-container" href="<?php echo site_url(); ?>" class="align-center blue-text text-darken-4" style="font-size: 22px;">
                             V2RealEstate Pvt Ltd<span style="font-weight: 400;"></span>
						</a>
                    </li>
                    <?php
