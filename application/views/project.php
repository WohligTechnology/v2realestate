<div class="fullwidth-section nofootmg" id="blog-fullwidth" style="padding-top: 0">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="img-thumb post-img-lg" style="background-image: url('<?php echo base_url('assets/img/pictures/warehouseinner.jpg');?>');">
                    <div class="img-overlay-solid" style="background-color:rgba(60,62,71,0.1);"></div>
                    <a class="expand-img" data-pp="prettyPhoto[blog-gallery]" href="<?php echo base_url('assets/img/pictures/warehouseinner.jpg');?>" title="View the incredible mountains of Switzerland"><i class="im-expand2"></i></a>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        ...
                        Fusce lacinia eleifend tortor ac feugiat. Morbi vel sapien justo. Sed ullamcorper leo eu quam luctus pellentesque. Quisque eget massa sagittis, pretium dolor pharetra, feugiat lectus. In consequat enim sit amet malesuada facilisis. Vivamus condimentum ante mauris, at porta purus sodales eu. Nunc vel orci rhoncus, faucibus nunc sit amet, iaculis libero. Morbi auctor in velit eget laoreet. Quisque euismod dui vitae magna tempor, sed ultrices lorem varius. Praesent nec consequat arcu. Sed a nisl magna. Curabitur ac ultrices leo. Duis pulvinar hendrerit dolor, ac viverra risus.</p>
                    <p>
                    </p>
                    <div class="img-float-left col-md-4">
                        <div class="blog-img-hover">
                            <div class="hover-full"><a data-pp="prettyPhoto[blog-gallery]" href="<?php echo base_url('assets/img/pictures/warehouseinner.jpg');?>" title="View the incredible mountains of Switzerland"><i class="im-expand2"></i></a></div>
                        </div>
                        <img alt="" class="img-responsive" src="<?php echo base_url('assets/img/pictures/warehouseinner.jpg');?>">
                    </div>
