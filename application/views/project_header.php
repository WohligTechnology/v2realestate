<head>
    ...
    <link href="<?php echo base_url('assets/css/icomoon.css');?>" media="screen" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/css/parallax-slider.css');?>" media="screen" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/css/prettyPhoto.css');?>" media="screen" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/jquery.nicescroll.plus.js');?>"></script>
...
<nav class="navbar navbar-default navbar-fixed-top navg" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand weight-900" href="<?php echo site_url('site') ?>" col-sm-6>
                    <h1> <img id="logo" alt="" src="<?php echo base_url('assets/img/logo.png');?>" class="logo"> v<span class="logoap">II</span>realestate</h1></a>
            </div>

            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="main-menu">
                <ul class="nav navbar-nav navbar-right abtul">
                    <li><a class="scrollto" href="<?php echo site_url('site#home') ?>">Home</a></li>
                    <li><a class="scrollto" href="<?php echo site_url('site#about') ?>">About</a></li>
                    <li><a class="scrollto" href="<?php echo site_url('site#portfolio') ?>">Projects</a></li>
                    </li>
                    <li><a class="scrollto" href="<?php echo site_url('site#contact') ?>">Contact</a></li>
                    <li>
