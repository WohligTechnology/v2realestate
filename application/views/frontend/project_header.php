<head>
	...
	<link rel="icon" href="<?php echo base_url('frontassets/img/favicon.png');?>" type="img/png">
	<link href="<?php echo base_url('frontassets/css/bootstrap.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('frontassets/css/buttons.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('frontassets/css/font-awesome.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('frontassets/css/icomoon.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('frontassets/css/parallax-slider.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url('frontassets/css/prettyPhoto.css');?>" media="screen" rel="stylesheet" type="text/css">
	<link id="header-switch" href="<?php echo base_url('frontassets/css/headers/dark.css');?>" media="screen" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="<?php echo base_url('frontassets/js/jquery.easing.1.3.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('frontassets/js/stellar.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('frontassets/js/counter.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('frontassets/js/jquery.prettyPhoto.js');?>"></script>
...
<nav class="navbar navbar-default navbar-fixed-top navg" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand weight-900" href="<?php echo site_url('website') ?>" col-sm-6>
				<h1> <img id="logo" alt="" src="<?php echo base_url('frontassets/img/logo.png');?>" class="logo">v<span class="logo2">2</span>real estate</h1></a>
		</div>
