...
<!--					<h4 class="weight-600"> V2 REAL ESTATE PRIVATE LIMITED is one of the fastest-growing Mumbai-based Real Estate Company.</h4>-->
			...
			<div class="abt-main-cont">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="about-cont">
							<p>At V2 Real Estate Private Limited, we provide Total Warehouse Project Solutions i.e. warehouse advisory, land procurement, architecture, construction, sourcing of warehouse equipment, storage system &amp; lease management. </p>
...
A COMPLETE SOLUTION FOR ALL WAREHOUSING REQUIREMENTS AND SERVICES</h5>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="about-cont">
							...
							<p>V2 Real Estate Pvt. Ltd.  is involved in following types of Office leasing:</p>
							...
							<p>
								...
								<span class="bold">  WARM SHELL:</span> Warm Shell Office space is where V2 Real Estate Pvt. Ltd.  does the basic civil works of the premises such as Flooring, False Ceiling and Rest Rooms. In some cases Air Conditioning and Light Fittings are also provided.</p>
							...
							<p><span class="bold">  1.) Ready Furnished Offices:</span> Generally these are offices which are sought after for an immediate start-up. Finding a Ready Furnished Office which exactly matches your requirement can be very gruesome task, thus, our clients rely on expertise of V2 Real Estate Pvt. Ltd.. </p>
			...
			<div class="abt-main-cont">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="about-cont">
							<p>V2 REAL ESTATE PVT. LTD is involved in serving banks to help them in their expansion plans. We provide premises for Bank Branches &amp; ATMs suitable to the needs of the banks. V2 Real Estate Pvt. Ltd. is having a specialty in identifying the best properties at a given location and caters to the needs of the banks.</p>
							<p>We offer the best deals to our clients and suffice their requirements.</p>
							<p>V2 Real Estate Pvt. Ltd.  is an organized real estate provider catering to the demands of MNCs, Banks, and Embassies for quality properties on Rent/Lease. V2 Real Estate Pvt. Ltd. is not a broker and it only leases out premises which are owned and occupied by it.</p>
						</div>
					</div>
				</div>
			</div>
